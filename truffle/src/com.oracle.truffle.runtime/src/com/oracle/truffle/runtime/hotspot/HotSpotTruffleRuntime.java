...
public final class HotSpotTruffleRuntime extends OptimizedTruffleRuntime {
    ...
    /**
     * Thi constant is used to detect when a method was invalidated by HotSpot because the code
    ...
    public HotSpotTruffleRuntime(TruffleCompilationSupport compilationSupport) {
        ...
        this.jvmciReplacedMethodInvalidationReason = vmConfigAccess.getConstant("nmethod::InvalidationReason::JVMCI_REPLACED_WITH_NEW_CODE", Integer.class);
        this.coldMethodInvalidationReason = vmConfigAccess.getConstant("nmethod::InvalidationReason::UNLOADING_COLD", Integer.class);
