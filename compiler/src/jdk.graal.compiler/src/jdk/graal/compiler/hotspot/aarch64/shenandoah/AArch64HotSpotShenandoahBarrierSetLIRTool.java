...
import jdk.graal.compiler.hotspot.HotSpotShenandoahBarrierSetLIRTool;
...
import jdk.graal.compiler.lir.aarch64.shenandoah.AArch64ShenandoahBarrierSetLIRTool;
import jdk.vm.ci.code.Register;

/**
 * The AArch64 HotSpot specific assembly helpers required for Shenandoah assembly barrier emission.
 */
public class AArch64HotSpotShenandoahBarrierSetLIRTool extends HotSpotShenandoahBarrierSetLIRTool implements AArch64ShenandoahBarrierSetLIRTool {

    public AArch64HotSpotShenandoahBarrierSetLIRTool(GraalHotSpotVMConfig config, HotSpotProviders providers) {
