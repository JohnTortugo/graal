...
public class ShenandoahPosWriteBarrier extends ObjectWriteBarrierNode implements DeoptimizingNode.DeoptBefore {

    public static final NodeClass<ShenandoahPosWriteBarrier> TYPE = NodeClass.create(ShenandoahPosWriteBarrier.class);

    @OptionalInput(InputType.State) private FrameState stateBefore;
    private final boolean nullCheck;
    private final boolean doLoad;

    public ShenandoahPosWriteBarrier(AddressNode address, ValueNode expectedObject, boolean doLoad, boolean nullCheck) {
