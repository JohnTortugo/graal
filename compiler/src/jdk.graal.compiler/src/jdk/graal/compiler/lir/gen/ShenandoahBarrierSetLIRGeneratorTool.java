...
public interface ShenandoahBarrierSetLIRGeneratorTool extends WriteBarrierSetLIRGeneratorTool {
    /**
    ...
    /**
     * @param address the location where the object was loaded from.
     * @param value the reference to the object
     */
    void emitLoadReferenceBarrier(LIRGeneratorTool lirTool, Value address, Value value, boolean isStrong, boolean isNarrow, boolean isWeak, boolean isPhantom);
}
